...
import { Button, TextInput, Textarea, Select, Grid, Flex, ActionIcon, Modal } from "@mantine/core";
      ...
      <div className="flex flex-col h-full w-full font-outfit">
        ...
        <form className="grid gap-6 p-8 h-full w- max-w-md mx-auto" onSubmit={form.onSubmit(onSubmit)}>
          ...
          <div className="flex flex-col items-center mt-6 gap-y-2">
            <button
              type="submit"
              className="rounded-3xl  bg-gradient-to-r from-teal-400 to-green-400 p-3 w-full text-2xl text-white font-bold active:scale-95 transition">
              Confirm
            </button>
            <Button
              variant="transparent"
